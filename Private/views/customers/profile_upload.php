    ...
    <section id="photo-upload">
        <div class="row justify-content-center">
            <div class="col-md-5 log-overlay">
                ...
                <div class="card-body">
                    <form action="<?php echo URL_ROOT; ?>customers/upload/<?php echo $_SESSION['id']; ?>" method="post"
                          enctype="multipart/form-data">
                        <h5>Please Select File</h5>
                        <p>file upload types: *.png, *.jpeg, *.gif</p>
                        <input type="file" name="file" class="<?php echo (!empty($data['file_error'])) ? 'is-invalid' : ''; ?>">
