 ...
 <div class="row border border-dark">
    ...
    <div class="col-sm-2">
      <div class="card text-left" style="width: 18rem;">
          <div class="card-body">
            <h5 class="card-title"><h4>BILLBOARD</h4></h5>
          </div>
      </div>
      </div>
    </div>
...
<div class="container-fluid bg-3 text-center">    
  ...
  <div class="col-md-2">
    ...
    <div class="well well-sm">
       <div class="btn-group-vertical ">
          <button type="button" class="btn btn-secondary">My Order</button>
          <button type="button" class="btn btn-secondary">My Tailor</button>
